...
function RenderSlide({ slide, index, total, onSources }) {
  ...
  return <section className={`slide content content--${slide.type}${dark?' dark':''}`}>
    ...
    {slide.type === 'growth' && <div className="growth">
      ...
      <article className="growth-story growth-story--unicorn"><img src={`${A3}saudi-unicorns.png`} alt="Saudi Unicorns Program"/><div className="growth-copy"><div className="unicorn-heading"><img src={`${A5}saudi-unicorns-logo.png`} alt="Saudi Unicorns"/><div><span>SELECTED IN 2023</span><h2>Saudi Unicorns Program</h2></div></div><p>Selection placed Manafa among companies with the potential to become globally significant Saudi technology businesses.</p><div className="unicorn-operators"><img src={`${A5}mcit.png`} alt="MCIT"/><img src={`${A5}misk.png`} alt="Misk"/><img src={`${A5}ntdp.png`} alt="NTDP"/></div></div></article>
    </div>}
    ...
    {slide.type === 'customer-channels' && <div className="customer-channels">
      <article className="channel-panel channel-panel--borrower"><div className="channel-copy"><img src={`${A5}manafa-business-icon.jpg`} alt="Manafa Business app icon"/><span>WEB · MOBILE</span><h2>Borrower relationship</h2><p>Businesses discover financing, apply, submit information and follow requests across Manafa Business channels.</p><div className="channel-steps"><b>Discover</b><i/><b>Apply</b><i/><b>Track</b></div></div><div className="channel-gallery"><figure><img src={`${A5}manafa-business-01.png`} alt="Manafa Business application screen"/></figure><figure><img src={`${A5}manafa-business-02.png`} alt="Manafa Business request journey"/></figure></div></article>
      <article className="channel-panel channel-panel--investor"><div className="channel-gallery"><figure><img src={`${A6}manafa-investor-01.png`} alt="Manafa investor opportunities screen"/></figure><figure><img src={`${A6}manafa-investor-02.png`} alt="Manafa investor preference journey"/></figure></div><div className="channel-copy"><img src={`${A6}manafa-investor-icon.jpg`} alt="Manafa investor app icon"/><span>WEB · MOBILE</span><h2>Investor relationship</h2><p>Investors onboard, discover opportunities, participate and monitor their portfolios across Manafa channels.</p><div className="channel-steps"><b>Onboard</b><i/><b>Invest</b><i/><b>Monitor</b></div></div></article>
    </div>}
