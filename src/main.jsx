...
function RenderSlide({ slide, index, total, onSources }) {
  ...
  return <section className={`slide content content--${slide.type}${dark?' dark':''}`}>
    ...
    {slide.type === 'customer-channels' && <div className="customer-channels">
      <article className="channel-panel channel-panel--borrower"><div className="channel-copy"><img src={`${A5}manafa-business-icon.jpg`} alt="Manafa Business app icon"/><span>WEB · MOBILE</span><h2>Borrower relationship</h2><p>Businesses discover financing, apply, submit information and follow requests across Manafa Business channels.</p></div><figure className="channel-visual"><img src={`${A5}manafa-business-01.png`} alt="Manafa Business application screen"/></figure></article>
      <article className="channel-panel channel-panel--investor"><figure className="channel-visual"><img src={`${A6}manafa-investor-01.png`} alt="Manafa investor opportunities screen"/></figure><div className="channel-copy"><img src={`${A6}manafa-investor-icon.jpg`} alt="Manafa investor app icon"/><span>WEB · MOBILE</span><h2>Investor relationship</h2><p>Investors onboard, discover opportunities, participate and monitor their portfolios across Manafa channels.</p></div></article>
    </div>}
